 ...
 * @version		$Id$
 * @package		ArthurXF
 * @subpackage	xingfu_school_teacher
 */
require_once('config/config.inc.php');
require_once("class/xingfu_school_teacher.class.php");
...
$strWhereLast = "where id > $intID";
$arrInfoListLast = $objWebInit->getInfoList($strWhereLast,' ORDER BY topflag DESC,submit_date DESC,id DESC',0,1,'id,title,submit_date,bedeck','',false);
...
$arrMOutput["smarty_assign"]['arrGWeb']['css'][] = 'xingfu_school_teacher02.css';
