<?php
/**
 * 兴甫简介功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'xingfu_Introduction';
$arrGPdoDB['db_table1'] = 'xingfu_Introduction_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = "兴甫简介";
$arrGWeb['module_id'] = 'xingfu_Introduction';
$arrGWeb['db_summary_len'] = 255;	//摘要生成长度设定,不能超过255,安装后修改，需要去手动调整表字段长度
