<?php
/**
 * 招生简介功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'xingfu_admissions';
$arrGPdoDB['db_table1'] = 'xingfu_admissions_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = "招生简介";
$arrGWeb['module_id'] = 'xingfu_admissions';
