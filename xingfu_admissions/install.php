...
include_once(dirname(__FILE__).'/class/xingfu_admissions.class.php');
...
$arrGMeta['xingfu_admissions']['cache'] = 1;//该栏目是否生成静态页，0=不可以，1=可以
$arrGMeta['xingfu_admissions']['admin'] = array(
								array(
...
$arrGMeta['xingfu_admissions']['meta'] = array(
									  'Title' => $arrGMeta['xingfu_admissions']['name'],
									  'Description' => $arrGMeta['xingfu_admissions']['name'],
									  'Keywords' => $arrGMeta['xingfu_admissions']['name'],
									);
...
//sql语句
if($_SESSION['install_type']) $sql[] = "DROP TABLE IF EXISTS `".$arrGPdoDB['db_tablepre']."xingfu_admissions`;";
...
if($_SESSION['install_type']) $sql[] = "DROP TABLE IF EXISTS `".$arrGPdoDB['db_tablepre']."xingfu_admissions_type`;";
