...
include_once(dirname(__FILE__).'/class/xingfu_school_show.class.php');

$objWebInit = new xingfu_school_show();
$objWebInit->db();
...
$arrGMeta['xingfu_school_show']['cache'] = 1;//该栏目是否生成静态页，0=不可以，1=可以
$arrGMeta['xingfu_school_show']['admin'] = array(
								array(
...
$arrGMeta['xingfu_school_show']['meta'] = array(
									  'Title' => $arrGMeta['xingfu_school_show']['name'],
									  'Description' => $arrGMeta['xingfu_school_show']['name'],
									  'Keywords' => $arrGMeta['xingfu_school_show']['name'],
									);
...
//sql语句
if($_SESSION['install_type']) $sql[] = "DROP TABLE IF EXISTS `".$arrGPdoDB['db_tablepre']."xingfu_school_show`;";
...
if($_SESSION['install_type']) $sql[] = "DROP TABLE IF EXISTS `".$arrGPdoDB['db_tablepre']."xingfu_school_show_type`;";
