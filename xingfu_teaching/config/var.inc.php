<?php
/**
 * 武术教学功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'xingfu_teaching';
$arrGPdoDB['db_table1'] = 'xingfu_teaching_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = "武术教学";
$arrGWeb['module_id'] = 'xingfu_teaching';
