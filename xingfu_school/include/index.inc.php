 ...
 * @version		$Id$
 * @package		ArthurXF
 * @subpackage	xingfu_school
 */
require_once('config/config.inc.php');
require_once("class/xingfu_school.class.php");
...
$arrInfoList = $objWebInit->getInfoList($strWhere,' ORDER BY topflag DESC,submit_date DESC',($intPage-1)*$arrGPage['page_size'],$arrGPage['page_size'],'id,type_id,title,submit_date,bedeck,thumbnail,summary');
...
$arrMOutput["smarty_assign"]['arrGWeb']['css'][] = 'xingfu_school.css';
