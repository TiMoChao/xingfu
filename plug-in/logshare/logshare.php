...
if(empty($arrCache_log)){
	...
	if(empty($_SESSION['user_id'])){
		...
		array_unshift($arrCache_log['user_log'],array('action'=>"<a href='/user/u_friend_detail/uid-".$_SESSION['user_id'].".html'>$_SESSION[nick_name]</a> 正在浏览 <a href='".$strMyUrl."'>《".$strTitle."》</a>",'time'=>time()));
