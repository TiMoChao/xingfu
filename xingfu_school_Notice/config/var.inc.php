<?php
/**
 * 兴甫幼儿园_ 通知公告功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'xingfu_school_Notice';
$arrGPdoDB['db_table1'] = 'xingfu_school_Notice_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = "兴甫幼儿园_ 通知公告";
$arrGWeb['module_id'] = 'xingfu_school_Notice';
