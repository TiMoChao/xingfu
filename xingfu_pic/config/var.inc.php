<?php
/**
 * 首页滑动图片功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
 * @author		Arthur(ArthurXF@gmail.com)
 * @copyright	(c) 2006 by bizeway.com
 * @version		$Id$
 * @package		ArthurXF
 * @subpackage	xingfu_pic
 */
...
*/
$arrGPdoDB['db_table'] = 'xingfu_pic';
$arrGPdoDB['db_table1'] = 'xingfu_pic_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = "首页滑动图片";
$arrGWeb['module_id'] = 'xingfu_pic';
...
$arrGPic['FileSourPicSize'] = array(1920,1080);
