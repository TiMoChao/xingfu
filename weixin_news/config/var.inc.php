<?php
/**
 * 微信_新闻资讯功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'weixin_news';
$arrGPdoDB['db_table1'] = 'weixin_news_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = "微信_新闻资讯";
$arrGWeb['module_id'] = 'weixin_news';
