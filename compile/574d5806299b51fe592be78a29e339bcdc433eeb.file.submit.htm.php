<?php /* Smarty version Smarty-3.0.7, created on 2015-12-05 17:03:54
         compiled from "/Volumes/data/wochacha_program/xingfu/xingfu_Introduction/config/../../xingfu_Introduction/admin/templats/submit.htm" */ ?>
<?php /*%%SmartyHeaderCode:399394045662a87a0dd861-46831358%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '574d5806299b51fe592be78a29e339bcdc433eeb' => 
    array (
      0 => '/Volumes/data/wochacha_program/xingfu/xingfu_Introduction/config/../../xingfu_Introduction/admin/templats/submit.htm',
      1 => 1449168828,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '399394045662a87a0dd861-46831358',
  'function' => 
  array (
  ),
...
" <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->getVariable('arrData')->value['type_id']){?>selected=selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['type']->value;?>
    ...
    <td><font color="red">*</font><span class=gray>简介分类</span></td></tr>
  <tr>
  	<td>标题：</td>
...
" onblur="splidword(this.value);"></td>
    <td><font color="red">*</font><span class=gray>标题，最大70个中文（只能填写兴甫简介！！）</span></td></tr>
  <tr>
    <!--<td>页面标题：</td>-->
