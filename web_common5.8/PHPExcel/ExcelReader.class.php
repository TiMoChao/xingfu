...
//define('ExcelReader_HAVE_ICONV', function_exists('iconv'));
//define('ExcelReader_HAVE_MB', function_exists('mb_convert_encoding'));
...
//class ExcelReader extends PEAR {
class ExcelReader {
...
//            $r = &$this->file->nextRecord();
    ...
    function createDate($numValue){
        if ($numValue > 1){
            ...
            $utcValue = round($utcDays * ExcelReader_msInADay);
