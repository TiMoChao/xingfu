...
$strFilename = '../../data/alipay.inc.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	$somecontent = '<?php' . "\n" . '$arrGAlipay= ' . var_export( $_POST, true ) . ';' . "\n" .'?>';
...
// 输出到模板
$arrMOutput["smarty_assign"]['strNav'] = '支付宝设置管理';
$arrMOutput["template_file"] = "admin.html";
$arrMOutput["smarty_assign"]['arrGAlipay'] = $arrGAlipay;
$arrMOutput["smarty_assign"]['MAIN'] = $arrGSmarty['admin_main_dir'].'siteset/alipay.htm';
