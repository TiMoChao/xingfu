<?php
/**
 * 单页栏目全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
$arrGPdoDB['db_table_field']=array('id'=>'','module_name'=>'','type_title_english'=>'','structon_tb'=>array('source','meta_Title','meta_Description','meta_Keywords','title','intro'));   //字段数组，将要显示的字段名称写入该数组
$arrGPdoDB['htmlspecialchars'] = array('intro');

//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '单页介绍';
