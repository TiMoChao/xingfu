<?php
/**
 * 微信_名教风采功能公有全局变量配置文件（可被block访问的网站配置全局变量）
 *
...
*/
$arrGPdoDB['db_table'] = 'weixin_xingfufengcai';
$arrGPdoDB['db_table1'] = 'weixin_xingfufengcai_type';
...
//网站公用参数（栏目数据）
$arrGWeb['module_name'] = "微信_名教风采";
$arrGWeb['module_id'] = 'weixin_xingfufengcai';
