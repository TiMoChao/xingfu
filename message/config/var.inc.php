...
*/
$arrGPdoDB['db_table'] = 'message';
$arrGPdoDB['db_table1'] = 'message_type';
$arrGPdoDB['db_table_field']=array('id'=>'','type_id'=>1,'user_id'=>1,'structon_tb'=>array('company','title','contact','tel','address','zip','email','intro','remark'),'submit_date'=>date('Y-m-d H:i:s'),'state'=>1,'user_ip'=>'','pass'=>1);   //字段数组，将要显示的字段名称写入该数组

//网站公用参数（栏目数据）
$arrGWeb['module_name'] = '网站留言';
$arrGWeb['module_id'] = 'message';
$arrGWeb['cache_message_url'] = $arrGWeb['cache_url'].'/'.$arrGWeb['module_id'];
